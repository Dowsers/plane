...
export type TBaseIssue = {
  ...
  type_id: string | null;
  // Category 6 feature 3 ("Work items recurrents") - set only on issues
  // generated by a RecurringIssueTemplate. `recurring_template_id` goes
  // null if the template is later deleted; `recurring_template_name_snapshot`
  // survives so a "Generated from: X" badge can still identify the
  // template by name - see docs/feature-specs/06-automation-workflow-sla.md
  // in plane-selfhost. Optional since older cached payloads won't have it.
  recurring_template_id?: string | null;
  recurring_template_name_snapshot?: string | null;
