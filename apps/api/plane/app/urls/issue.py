...
from plane.app.views import (
    ...
    IssueGanttDependenciesEndpoint,
...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/issues/gantt-dependencies/",
        IssueGanttDependenciesEndpoint.as_view(),
        name="issue-gantt-dependencies",
    ),
    ## End Issue Relation
    path(
