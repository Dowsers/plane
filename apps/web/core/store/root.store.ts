...
import type { IRoadmapStore } from "./roadmap.store";
...
import type { IProjectUpdateStore } from "./project-update.store";
import { ProjectUpdateStore } from "./project-update.store";
...
export class CoreRootStore {
  ...
  constructor() {
    ...
    this.customDashboard = new CustomDashboardStore(this);
    ...
    this.pageCollections = new PageCollectionStore(this as unknown as RootStore);
