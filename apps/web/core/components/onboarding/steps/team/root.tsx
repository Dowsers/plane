    ...
    <div>
        ...
        <div className="col-span-6">
          <Controller
            ...
            rules={{
              pattern: {
                value: emailRegex,
                message: t("onboarding.invite_team.errors.invalid_email"),
              },
            }}
      ...
      {email && !emailRegex.test(email) && (
        <div className="mx-8 my-1">
          ...
          <span className="mt-1 text-11 text-danger-primary">{t("onboarding.invite_team.errors.not_an_email")}</span>
        </div>
      )}
    </div>
  );
  ...
  return (
    ...
    >
      <CommonOnboardingHeader
        title={t("onboarding.invite_team.header.title")}
        description={t("onboarding.invite_team.header.description")}
      />
      <div className="w-full py-4 text-13">
        ...
        >
          ...
          {t("onboarding.invite_team.add_another")}
        </button>
      </div>
      <div className="mx-auto flex w-full flex-col items-center justify-center gap-4 px-8 sm:px-2">
        ...
        <Button variant="ghost" size="xl" className="w-full" onClick={nextStep}>
          {t("onboarding.invite_team.do_it_later")}
        </Button>
      </div>
    </form>
  );
