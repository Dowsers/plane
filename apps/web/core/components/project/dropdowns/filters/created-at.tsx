    ...
    <>
      {isDateFilterModalOpen && (
        <DateFilterModal
          ...
          title={t("project.filters.created_at.title")}
        />
      )}
      <FilterHeader
        title={
          appliedFiltersCount > 0
            ? `${t("project.filters.created_at.title")} (${appliedFiltersCount})`
            : t("project.filters.created_at.title")
        }
          ...
          {filteredOptions.length > 0 ? (
            <>
              ...
              <FilterOption
                ...
                title={t("project.filters.custom")}
                multiple={false}
              />
            </>
          ) : (
