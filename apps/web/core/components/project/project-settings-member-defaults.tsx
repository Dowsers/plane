  ...
  return (
    <div className="my-6 flex flex-col gap-y-6">
      <DefaultSettingItem
        ...
        description={t("project.settings.member_defaults.project_lead_description")}
      >
        {currentProjectDetails ? (
          <Controller
            control={control}
      ...
      <DefaultSettingItem
        ...
        description={t("project.settings.member_defaults.default_assignee_description")}
      >
        {currentProjectDetails ? (
          <Controller
            control={control}
      ...
      {currentProjectDetails && (
        <DefaultSettingItem
          title={t("project.settings.member_defaults.guest_access_title")}
