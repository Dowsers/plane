...
const EXPIRY_DATE_OPTIONS = [
  {
    key: "1_week",
    label: "workspace_settings.settings.api_tokens.expiry_options.1_week",
    value: { weeks: 1 },
  },
  {
    key: "1_month",
    label: "workspace_settings.settings.api_tokens.expiry_options.1_month",
    value: { months: 1 },
  },
  {
    key: "3_months",
    label: "workspace_settings.settings.api_tokens.expiry_options.3_months",
    value: { months: 3 },
  },
  {
    key: "1_year",
    label: "workspace_settings.settings.api_tokens.expiry_options.1_year",
    value: { years: 1 },
  },
];
  ...
  const handleFormSubmit = async (data: IApiToken) => {
    ...
    if (!neverExpires && (!data.expired_at || (data.expired_at === "custom" && !customDate)))
      return setToast({
        ...
        message: t("workspace_settings.settings.api_tokens.errors.expiration_date_required"),
      });
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <CustomSelect.Option value="custom">
                        {t("workspace_settings.settings.api_tokens.expiry_options.custom")}
                      </CustomSelect.Option>
                    </CustomSelect>
                  );
                }}
      ...
      <div className="flex items-center justify-between gap-2 border-t-[0.5px] border-subtle px-5 py-4">
        <button type="button" className="flex cursor-pointer items-center gap-1.5" onClick={toggleNeverExpires}>
